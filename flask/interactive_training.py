...
def make_corrected_nlu(corrected_intent, sender_id, tracker):
    # tracker = core.get_tracker(sender_id)
...
def correct_wrong_nlu(corrected_nlu: Dict[Text, Any], sender_id: Text, tracker):
    ...
    replaced_events_tracker = core.replace_events(sender_id, corrected_events)
